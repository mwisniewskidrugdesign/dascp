...
def not_friends(user, other_user):
    """Użytkownik other_user nie jest znajomym, jeżeli nie należy do listy user["friends"], a więc jego nazwa nie pokrywa się z nazwą żadnego z użytkowników umieszczonych na liście."""
...
if __name__ == "__main__":
    ...
    print sorted(num_friends_by_id,
                 key=lambda (user_id, num_friends): num_friends, # Sortuj według liczby znajomych
